...
│
├── build/                  # 构建相关
│   ├── pyinstaller/        # PyInstaller构建目录
│   ├── build.py            # Python构建脚本
│   ├── build.ps1           # PowerShell构建脚本
│   ├── electron-builder.json # Electron构建配置
│   ├── pyinstaller.spec    # PyInstaller配置文件
│   └── README.md           # 构建说明文档
│
├── scripts/                # 脚本工具
...
├── .husky/                 # Git hooks配置
├── CHANGELOG.md            # 更新日志
├── COMMIT_CONVENTION.md    # 提交规范指南
├── commitlint.config.js    # Commit lint配置
├── version.json            # 详细版本信息
├── version.txt             # 简化版本号
├── package.json            # 项目配置
...
5. **版本管理问题**
   - 确保Git已安装并正确配置
   - 检查提交格式是否符合规范
   - 验证version.json和CHANGELOG.md是否正确更新

---

## 🤝 贡献指南

欢迎提交Issues和Pull Requests来共同改进这个项目！

1. Fork本仓库
2. 创建您的特性分支 (`git checkout -b feature/AmazingFeature`)
3. 提交您的更改 (使用规范: `git commit -m 'feat: add some feature'`)
4. 推送到分支 (`git push origin feature/AmazingFeature`)
5. 开启一个Pull Request

更多关于提交规范的信息，请参考 [提交规范](./COMMIT_CONVENTION.md)。

---

## 📄 许可证

本项目采用MIT许可证 - 查看 [LICENSE](https://github.com/AstraSolis/QuickStart/blob/master/LICENSE) 文件了解详情
